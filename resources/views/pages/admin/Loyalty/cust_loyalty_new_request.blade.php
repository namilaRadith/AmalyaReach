                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            @foreach ($loyalties as $loyalty)
                                <tr>
                                    ...
                                    <th style="color: #2b2b2b"><?php if($loyalty['recieve_p_offers']){echo "YES";}else "NO"; ?></th>
                                    <th style="color: #2b2b2b"><?php if($loyalty['allow_p_p_offers']){echo "YES";}else "NO"; ?></th>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form role="form" action="{{ action('LoyaltyController@Accept_loyalty_request_submit') }}" method="post" accept-charset="UTF-8">
                        <div class="box-body col-md-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Email address</label>
                                <input  name ="form_cust_email" id = "form_cust_email" type="text" class="form-control"  disabled="disabled">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Name</label>
                                <input type="text" name="form_cust_name" id="form_cust_name"class="form-control"  disabled="disabled" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Address</label>
                                <input type="text" name="form_cust_address" id="form_cust_address" class="form-control"  disabled="disabled" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Contact</label>
                                <input type="text" name="form_cust_contact" id="form_cust_contact" class="form-control"  disabled="disabled">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Gender</label>
                                <input type="text" name="form_cust_gender" id="form_cust_gender" class="form-control"  disabled="disabled">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">D.O.B</label>
                                <input type="text" name="form_cust_DOB" id="form_cust_DOB" class="form-control"  disabled="disabled">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Nationality</label>
                                <input type="text" name="form_cust_nationality" id="form_cust_nationality" class="form-control"  disabled="disabled">
                            </div>
                        </div>
                        <div class="box-body col-md-6">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Children</label>
                                <input type="text" name="form_cust_children" id="form_cust_children" class="form-control"  disabled="disabled">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Allow Personalized Offers</label>
                                <input type="text" name="form_cust_allowPO" id="form_cust_allowPO"  class="form-control" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Allow Parters Personlized Offers</label>
                                <input type="text" name="form_cust_allowPPO" id="form_cust_allowPPO" class="form-control" >
                            </div>
                            ...
                            <div class="form-group">
                                <label>Select</label>
                                <select class="form-control" name = "loyalty_type">
                            ...
                            <div class="form-group">
                                <div class="checkbox" name = "send_p_offers">
                                    <label>
                                        <input type="checkbox">
                                        Send Special Offers
                                    </label>
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="send_p_p_offers">
