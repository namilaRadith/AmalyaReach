	...
	<div class="tp-banner">
		<ul>
			...
			<li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
				<!-- MAIN IMAGE -->
				<img src="{{asset('client/img/slides_bg/dummy.png')}}" alt="slidebg1" data-lazyload="{{asset('client/img/slides_bg/slide_1.jpg')}}" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
				<!-- LAYER NR. 1 -->
			...
			<li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
				<!-- MAIN IMAGE -->
				<img src="{{asset('client/img/slides_bg/dummy.png')}}" alt="slidebg1" data-lazyload="{{asset('client/img/slides_bg/slide_6.jpg')}}" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
				<!-- LAYER NR. 1 -->
			...
			<li data-transition="fade" data-slotamount="7" data-masterspeed="500" data-saveperformance="on" data-title="Intro Slide">
				<!-- MAIN IMAGE -->
				<img src="{{asset('client/img/slides_bg/dummy.png')}}" alt="slidebg1" data-lazyload="{{asset('client/img/slides_bg/slide_4.jpg')}}" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat">
				<!-- LAYER NR. 1 -->
