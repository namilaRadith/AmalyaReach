...
<section class="sub_header" id="bg_room">
        ...
        <div class="sub_header_content">
            <div class="animated fadeInDown">
                <h1>Special Offers on Below Room</h1>
                <p>
                    AMALYA makes it easier to stay on with up to 20% off your room and breakfast on us every day. Get more savings on all the details that matter with each ...
                </p>
            </div>
        </div>
    </section><!-- End Section -->
                ...
                <div class="strip_all_rooms_list wow fadeIn" data-wow-delay="0.1s">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="img_list">
                                <a href="room_details.html"><img src="{{ asset('client/img/images2.jpg') }}" alt=""></a>
                            </div>
                        </div>
...
Sed pretium, ligula sollicitudin laoreet viverra, tortor libero sodales leo, eget blandit nunc tortor eu nibh. Lorem ipsum dolor sit amet, consectetuer adipiscing elit....
                ...
                <div class="strip_all_rooms_list wow fadeIn" data-wow-delay="0.2s">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="img_list">
                                <a href="room_details.html"><img src="{{ asset('client/img/images1.jpg') }}" alt=""></a>
                            </div>
                        </div>
                        <div class="clearfix visible-xs-block">
                        </div>
...
Sed pretium, ligula sollicitudin laoreet viverra, tortor libero sodales leo, eget blandit nunc tortor eu nibh. Lorem ipsum dolor sit amet, consectetuer adipiscing elit....
                ...
                <div class="strip_all_rooms_list wow fadeIn" data-wow-delay="0.3s">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="img_list">
                                <a href="room_details.html"><img src="{{ asset('client/img/images.jpg') }}" alt=""></a>
                            </div>
                        </div>
                        <div class="clearfix visible-xs-block">
                        </div>
