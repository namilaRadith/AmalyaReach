...
<link href="{{asset('/admin/plugins/timepicker/bootstrap-timepicker.css')}}" rel="stylesheet">
    ...
    <div class="row">
        <div class="col-md-12">
           <p> At Amalya Resort you’re spoilt for choice with three dinnings, one bars and a terace.
               Relax by the pool as refreshing drinks are handed to you on a lounger. Grab a light bite or tuck into a feast in air conditioned comfort.  Dine on a deck with a fresh sea breeze and open water view.  Chill out at sunset with tropical cocktails and live entertainment, or chat over bar drinks with a Caribbean swing.  From casual, fine dining and in-room privacy, to menus of international favourites, Malay and Chinese specialties, enjoying what you want when you want is what it’s all about.
           </p>
            <hr>
        </div>
    </div>
                            ...
                            <div class="col-md-12">
                                @foreach($dining as $dining )
                                    <div class="col-md-4 col-sm-4 box_style_1">
                                        ...
                                        <div class="col-md-15">
                                            <input type="button" value="Make Reservation" class="btn_1 btn_full" id="{{$dining->id}}" onclick="popUpFunction(this)">
                                        </div>
                                    </div>
                                @endforeach
                                </div>
...
<div class=".ui-widget  ui-widget-overlay " id="dialog-form" >
    ...
    <form id="dinningRes" method="post" action="diningReservationSubmit" autocomplete="off" >
        ...
        <div class="row">
            <div class="col-md-12">
            <div class="panel-heading" style="background-color: #500a6f; color: white">Make a reservation at Amalya Resorts </div>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            <img src="http://www.avanihotels.com/kalutara/wp-content/themes/avanihotels/images/personal_info_en.jpg" alt="Personal Information"/>
                        </div>
                        <hr>
                    </div>
                    <div class="col-md-6 col-sm-6" style=" border-left: solid grey;">
                        <div class="form-group">
                            <img src="http://www.avanihotels.com/kalutara/wp-content/themes/avanihotels/images/party_information_en.jpg" alt="Booking Information"/>
                        </div>
                        <hr>
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-md-6">
                                        ...
                                        <input class="date-pick form-control" type="text" id="bookingDate" name="bookingDate" placeholder="Date" value="">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group clockpicker">
                                            <input type="text" class="form-control" value="09:30" id="bookingTime" name="bookingTime">
                ...
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="lastName" name="lastName" placeholder="Enter First Name">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="qty-buttons">
                                            ...
                                            <input type="text" name="adults" id="adults" class="qty form-control" placeholder="2">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="qty-buttons">
                                            ...
                                            <input type="text" name="children" id="children" class="qty form-control" placeholder="0">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6" style=" border-left: solid grey;">
                        <div class="form-group">
                            <input type="button" id="btnFormSubmit" class="btn_full" style="background-color: #500a6f;color: white" value="Make Reservation" onclick="formValidate()">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="panel-body col-md-12">
                    <div class="row">
                      <div class="col-md-12"></div>
                       ...
                       <div class="col-md-10">
                       <h5>Thank you for making a reservation. We will contact you shortly to confirm the date and time you wish to dine with us.</h5>
                       <div class="col-md-12"></div>
                       <div class="col-md-12"></div>
                       <div class="col-md-12"></div>
                       </div>
        ...
        function popUpFunction(val)
        {
            ...
            $(function() {
                ...
                $("#btnClose").button().on( "click",function(){
                    dialog.dialog( "close" );
                    $(".error").text("");
                    $("#dinningRes").find('input[type="text"],textarea').val('');
                    $(".wrap").css({
                        opacity: 1
                    });
